...
$procards = $db->prepare('SELECT m.name, m.picture, p.* FROM members m, projects p WHERE m.id=p.member_id ORDER BY p.created DESC LIMIT ?, 6');
...
<body>
    ...
    <div class="container">
        ...
        <div class="card-deck" style="text-align: center;">
            ...
            <ul class="paging">
                <?php if ($page > 1) : ?>
                    <li><a href="joinproject.php?page=<?php print($page - 1); ?>">前のページへ</a></li>
                <?php else : ?>
                    <li>前のページへ</a></li>
                <?php endif; ?>

                <?php if ($page < $maxPage) : ?>
                    <li><a href="joinproject.php?page=<?php print($page + 1); ?>">次のページへ</a></li>
                <?php else : ?>
                    <li>次のページへ</a></li>
                <?php endif; ?>
            </ul>
