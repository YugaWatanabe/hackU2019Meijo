    ...
    <div class="container">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="project_name" class="comment-text" size="35" maxlength="255" value="" id="name1" placeholder=" プロジェクト名を入力 ">

                <?php if ($error['project_name'] === 'blank') : ?>
                    <p class="error">プロジェクト名を入力</p>
                <?php endif; ?>

            </div>
            <div class="form-group">
                <label for="exampleFormControlTextarea1">概要メッセージ</label>
                <textarea class="comment-text" name="message" cols="45" rows="3" placeholder=" 概要を入力 "><?php print(htmlspecialchars($message, ENT_QUOTES)); ?></textarea>
                ...
                <label for="custom-select-1b">開催地域:</label>
                <select id="custom-select-1b" class="custom-select" name="place_id">
                    ...
                    <option value="9">福岡県</option>
                    <option value="14">宮城県</option>
                    <option value="20">岡山県</option>
                    <option value="25">沖縄県</option>
